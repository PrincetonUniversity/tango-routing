...
control IngressControl(inout hdr_t hdr,
  ...
  bit<8> route_manager_0_idx_4412;
  ...
  bit<16> forward_tango_pkt_arg_38;
  action labeledstmt_98(){
    forward_tango_pkt_arg_38=hdr.forward_flow.forward_flow_udp_header_3;
  }
  bit<16> forward_tango_pkt_arg_37;
  action labeledstmt_97(){
    forward_tango_pkt_arg_37=hdr.forward_flow.forward_flow_udp_header_2;
  }
  bit<16> forward_tango_pkt_arg_36;
  action labeledstmt_96(){
    forward_tango_pkt_arg_36=hdr.forward_flow.forward_flow_udp_header_1;
  }
  bit<16> forward_tango_pkt_arg_35;
  action labeledstmt_95(){
    forward_tango_pkt_arg_35=hdr.forward_flow.forward_flow_udp_header_0;
  }
  bit<32> forward_tango_pkt_arg_34;
  action labeledstmt_94(){
    forward_tango_pkt_arg_34=hdr.forward_flow.forward_flow_ip_header_9;
  }
  bit<32> forward_tango_pkt_arg_33;
  action labeledstmt_93(){
    forward_tango_pkt_arg_33=hdr.forward_flow.forward_flow_ip_header_8;
  }
  bit<16> forward_tango_pkt_arg_32;
  action labeledstmt_92(){
    forward_tango_pkt_arg_32=hdr.forward_flow.forward_flow_ip_header_7;
  }
  bit<8> forward_tango_pkt_arg_31;
  action labeledstmt_91(){
    forward_tango_pkt_arg_31=hdr.forward_flow.forward_flow_ip_header_6;
  }
  bit<8> forward_tango_pkt_arg_30;
  ...
  action labeledstmt_99(){
    route_manager_0_idx_4412=hdr.update_route.update_route_update_0;
  }
  ...
  route_manager_0_regaction_4413 = {
...
RouteManager_get_path_id_ret=route_manager_0_regaction_4413.execute(route_manager_0_idx_4412);
  }
  ...
  RegisterAction<bit<8>,bit<8>,bit<8>>(route_manager_0)
  route_manager_0_regaction_4414 = {
    void apply(inout bit<8> cell1_remote,
        out bit<8> ret_remote){
      bit<8> cell1_local=cell1_remote;
      bit<8> cell2_local=0;
  ...
  action labeledstmt_125(){
    route_manager_0_regaction_4414.execute(route_manager_0_idx_4412);
  }
  ...
  action labeledstmt_136(){
    tango_tunnel_hdr_1=(16w18+hdr.forward_flow.forward_flow_ip_header_2);
  }
  ...
  sequence_counters_0_regaction_4415 = {
...
SequenceNumberManager_increment_ret=sequence_counters_0_regaction_4415.execute(path_id);
  }
...
hdr.incoming_tango_traffic.incoming_tango_traffic_encaped_ip_header_8=forward_tango_pkt_arg_33;
   
hdr.incoming_tango_traffic.incoming_tango_traffic_encaped_ip_header_9=forward_tango_pkt_arg_34;
   
hdr.incoming_tango_traffic.incoming_tango_traffic_encaped_udp_header_0=forward_tango_pkt_arg_35;
   
hdr.incoming_tango_traffic.incoming_tango_traffic_encaped_udp_header_1=forward_tango_pkt_arg_36;
   
hdr.incoming_tango_traffic.incoming_tango_traffic_encaped_udp_header_2=forward_tango_pkt_arg_37;
   
hdr.incoming_tango_traffic.incoming_tango_traffic_encaped_udp_header_3=forward_tango_pkt_arg_38;
