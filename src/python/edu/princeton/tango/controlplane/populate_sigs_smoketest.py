...
def main() -> None:
    ...
    pkts.append(
        ...
        / IPv6()
        / UDP()
        / SignatureMetadata(sig_type=SignatureType.SEQNUM_SIG.value, sig_idx=4, block_idx=1)
    ...
    pkts.append(
        ...
        / IPv6()
        / UDP()
        / SignatureMetadata(sig_type=SignatureType.SEQNUM_SIG.value, sig_idx=5, block_idx=1)
    ...
    pkts.append(
        ...
        / IPv6()
        / UDP()
        / SignatureMetadata(sig_type=SignatureType.TS_SIG.value, sig_idx=4, block_idx=1)
        / Signature(signature=5)
        / Signature(signature=0),
    )
    ...
    pkts.append(
        ...
        / IPv6()
        / UDP()
        / SignatureMetadata(sig_type=SignatureType.TS_SIG.value, sig_idx=5, block_idx=1)
        / Signature(signature=6)
        / Signature(signature=7)
        / Signature(signature=8)
        / Signature(signature=0),
