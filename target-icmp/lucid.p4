...
header update_route_t {
  ...
  bit<32> update_route_icmp_header_3;
...
header incoming_tango_traffic_t {
  ...
  bit<32> incoming_tango_traffic_tango_icmp_header_3;
...
control IngressControl(inout hdr_t hdr,
  ...
  bit<8> route_manager_0_idx_4519;
  ...
  action labeledstmt_69(){
    route_manager_0_idx_4519=hdr.update_route.update_route_update_0;
  }
  ...
  action labeledstmt_89(){
    route_manager_0_idx_4519=traffic_class;
  }
  ...
  route_manager_0_regaction_4520 = {
...
RouteManager_get_path_id_ret=route_manager_0_regaction_4520.execute(route_manager_0_idx_4519);
  }
  action labeledstmt_27(){
    labeledstmt_90();
  }
  RegisterAction<bit<8>,bit<8>,bit<8>>(route_manager_0)
  route_manager_0_regaction_4521 = {
    void apply(inout bit<8> cell1_remote,
        out bit<8> ret_remote){
      bit<8> cell1_local=cell1_remote;
      bit<8> cell2_local=0;
  ...
  action labeledstmt_91(){
    route_manager_0_regaction_4521.execute(route_manager_0_idx_4519);
  }
  ...
  sequence_counters_0_regaction_4522 = {
...
SequenceNumberManager_increment_ret=sequence_counters_0_regaction_4522.execute(path_id);
  }
...
hdr.incoming_tango_traffic.incoming_tango_traffic_tango_icmp_header_0=8w8;
   
hdr.incoming_tango_traffic.incoming_tango_traffic_tango_icmp_header_1=8w0;
   
hdr.incoming_tango_traffic.incoming_tango_traffic_tango_icmp_header_2=16w0;
   
hdr.incoming_tango_traffic.incoming_tango_traffic_tango_icmp_header_3=32w0;
