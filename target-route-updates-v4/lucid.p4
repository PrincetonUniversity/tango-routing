...
control IngressControl(inout hdr_t hdr,
  ...
  bit<8> route_manager_0_idx_2149;
  ...
  action labeledstmt_40(){
    route_manager_0_idx_2149=hdr.update_route.update_route_update_0;
  }
  ...
  action labeledstmt_42(){
    route_manager_0_idx_2149=traffic_class;
  }
  ...
  route_manager_0_regaction_2150 = {
...
RouteManager_get_path_id_ret=route_manager_0_regaction_2150.execute(route_manager_0_idx_2149);
  }
  action labeledstmt_10(){
    labeledstmt_43();
  }
  RegisterAction<bit<8>,bit<8>,bit<8>>(route_manager_0)
  route_manager_0_regaction_2151 = {
    void apply(inout bit<8> cell1_remote,
        out bit<8> ret_remote){
      bit<8> cell1_local=cell1_remote;
      bit<8> cell2_local=0;
  ...
  action labeledstmt_44(){
    route_manager_0_regaction_2151.execute(route_manager_0_idx_2149);
  }
...
forward_tango_pkt_arg_13=(hdr.forward_flow.forward_flow_ip_header_2+16w18);
  ...
  sequence_counters_0_regaction_2152 = {
...
SequenceNumberManager_increment_ret=sequence_counters_0_regaction_2152.execute(path_id);
  }
  bit<12> timestamp;
...
hdr.incoming_tango_traffic.incoming_tango_traffic_encaped_udp_header_3=forward_tango_pkt_arg_33;
  ...
  table table_2162 {
    ...
    const entries = {
      (_,_,_,_,_,2) : labeledstmt_7();
      (_,_,_,_,_,1) : labeledstmt_8();
  ...
  table table_2161 {
    ...
    const entries = {
      (_,_,_,_,_,2) : labeledstmt_9();
      (_,_,_,_,_,1) : labeledstmt_10();
      (_,_,_,_,_,3) : labeledstmt_11();
  ...
  table table_2160 {
    ...
    const entries = {
      (2,_,_,_,_,_) : labeledstmt_12();
      (1,_,_,_,_,_) : labeledstmt_13();
      (3,_,_,_,_,_) : labeledstmt_14();
      (_,_,_,_,_,_) : labeledstmt_12();
    } 
  } 
  table table_2159 {
    key = {
