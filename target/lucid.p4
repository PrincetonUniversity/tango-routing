...
control IngressControl(inout hdr_t hdr,
  ...
  route_manager_0_regaction_2096 = {
...
RouteManager_get_path_id_ret=route_manager_0_regaction_2096.execute(traffic_class);
  }
...
forward_tango_pkt_arg_4=(hdr.forward_flow.forward_flow_ip_header_2+16w88);
  ...
  sequence_counters_0_regaction_2097 = {
...
SequenceNumberManager_increment_ret=sequence_counters_0_regaction_2097.execute(path_id);
  }
  bit<12> timestamp;
