...
def main():
    ...
    parser.add_argument(
        "--ports_up",
        help="set ports_up to true",
        action="store_true",
        default=(not is_model_running()),
    )
    parser.add_argument(
        "--globals_json", help="JSON file of global variables", default="globals.json"
    )
...
mc_groups = [
    (640, [(129, 0), (130, 0), (131, 0)]),
    (641, [(128, 0), (130, 0), (131, 0)]),
    (642, [(128, 0), (129, 0), (131, 0)]),
    (643, [(128, 0), (129, 0), (130, 0)]),
    (1, [(196, 1)]),
    (2, [(196, 1), (196, 2)]),
    (3, [(196, 1), (196, 2), (196, 3)]),
]
