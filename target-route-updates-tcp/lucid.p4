...
control IngressControl(inout hdr_t hdr,
  ...
  bit<8> route_manager_0_idx_4757;
  ...
  action labeledstmt_102(){
    route_manager_0_idx_4757=hdr.update_route.update_route_update_0;
  }
  ...
  action labeledstmt_124(){
    route_manager_0_idx_4757=traffic_class;
  }
  ...
  route_manager_0_regaction_4758 = {
...
RouteManager_get_path_id_ret=route_manager_0_regaction_4758.execute(route_manager_0_idx_4757);
  }
  ...
  RegisterAction<bit<8>,bit<8>,bit<8>>(route_manager_0)
  route_manager_0_regaction_4759 = {
    void apply(inout bit<8> cell1_remote,
        out bit<8> ret_remote){
      bit<8> cell1_local=cell1_remote;
      bit<8> cell2_local=0;
  ...
  action labeledstmt_128(){
    route_manager_0_regaction_4759.execute(route_manager_0_idx_4757);
  }
  ...
  sequence_counters_0_regaction_4760 = {
...
SequenceNumberManager_increment_ret=sequence_counters_0_regaction_4760.execute(path_id);
  }
