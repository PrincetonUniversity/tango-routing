...
control IngressControl(inout hdr_t hdr,
  ...
  bit<16> merged_var_precompute3774_precompute3772_3795;
  ...
  bit<16> precompute3773;
  action labeledstmt_70(){
    precompute3773=(hdr.forward_flow.forward_flow_ip_header_2+16w18);
  }
  ...
  sequence_counters_0_regaction_3796 = {
  ...
  action labeledstmt_65(){
    to_immediate_tmp=sequence_counters_0_regaction_3796.execute(32w0);
  }
  ...
  bit<32> MetricSignatureManager_sign_ret3140;
  action labeledstmt_72(){
    MetricSignatureManager_sign_ret3140=32w32;
  }
  bit<12> timestamp3139;
  action labeledstmt_71(){
    timestamp3139=(hdr.set_signature.set_signature_curr_signature[11:0]);
  }
  action labeledstmt_4(){
    labeledstmt_71();
    labeledstmt_72();
  }
  bit<16> precompute3776;
  action labeledstmt_74(){
    precompute3776=(16w1+hdr.set_signature.set_signature_sig_idx);
  }
  bit<16> precompute3775;
  action labeledstmt_73(){
    precompute3775=(hdr.set_signature.set_signature_ip_header_1-16w32);
  }
...
merged_var_precompute3774_precompute3772_3795=((bit<16>)(timestamp3139[4:0]));
  }
...
hdr.set_next_signature.set_next_signature_ip_header_0=hdr.set_signature.set_signature_ip_header_0;
    hdr.set_next_signature.set_next_signature_ip_header_1=precompute3775;
...
hdr.set_next_signature.set_next_signature_sig_type=hdr.set_signature.set_signature_sig_type;
    hdr.set_next_signature.set_next_signature_sig_idx=precompute3776;
...
merged_var_precompute3774_precompute3772_3795=((bit<16>)(timestamp[4:0]));
  }
  bit<16> tango_metrics_hdr_1;
  CRCPolynomial<bit<16>>(1,false, false, false, 0, 0) hash_37970_crc;
  Hash<bit<16>>(HashAlgorithm_t.CUSTOM,hash_37970_crc) hash_37970;
  action labeledstmt_79(){
    tango_metrics_hdr_1=hash_37970.get({timestamp});
  }
  bit<16> seq_number;
...
RegisterAction<bit<32>,bit<16>,bit<32>>(outgoing_metric_signature_manager_0)
  outgoing_metric_signature_manager_0_regaction_3798 = {
...
MetricSignatureManager_sign_ret=outgoing_metric_signature_manager_0_regaction_3798.execute(merged_var_precompute3774_precompute3772_3795);
  }
  bit<16> precompute;
...
RegisterAction<bit<32>,bit<16>,bit<32>>(outgoing_metric_signature_manager_0)
  outgoing_metric_signature_manager_0_regaction_3799 = {
    void apply(inout bit<32> cell1_remote,
        out bit<32> ret_remote){
      bit<32> cell1_local=cell1_remote;
      bit<32> cell2_local=0;
...
MetricSignatureManager_sign_ret3140=outgoing_metric_signature_manager_0_regaction_3799.execute(merged_var_precompute3774_precompute3772_3795);
  }
  ...
  outgoing_book_signature_manager_0_regaction_3800 = {
    void apply(inout bit<32> cell1_remote,
        out bit<32> ret_remote){
      bit<32> cell1_local=cell1_remote;
      bit<32> cell2_local=0;
...
sig_bitstring=outgoing_book_signature_manager_0_regaction_3800.execute(precompute);
  }
...
hdr.incoming_tango_traffic.incoming_tango_traffic_tango_ip_header_1=precompute3773;
...
hdr.incoming_tango_traffic.incoming_tango_traffic_encaped_udp_header_3=hdr.forward_flow.forward_flow_udp_header_3;
  ...
  @ignore_table_dependency("IngressControl.table_3806")table table_3805 {
    key = {
      hdr.wire_ev.event_id : ternary;
  ...
  @ignore_table_dependency("IngressControl.table_3805")table table_3806 {
    key = {
      hdr.wire_ev.event_id : ternary;
    }
    actions = {
