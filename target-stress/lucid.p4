...
control IngressControl(inout hdr_t hdr,
  ...
  bit<4> merged_var_precompute4055_sig_addr_precompute4052_4097;
  bit<10> merged_var_precompute4054_word_addr_precompute_4096;
  ...
  bit<16> precompute4053;
  action labeledstmt_85(){
    precompute4053=(hdr.forward_flow.forward_flow_ip_header_2+16w18);
  }
  ...
  bit<16> precompute4056;
  action labeledstmt_87(){
    precompute4056=(16w1+hdr.set_signature.set_signature_sig_idx);
  }
  ...
  sequence_counters_0_regaction_4098 = {
...
SequenceNumberManager_increment_ret=sequence_counters_0_regaction_4098.execute(32w0);
  }
...
merged_var_precompute4054_word_addr_precompute_4096=((bit<10>)hdr.set_signature.set_signature_sig_idx);
  }
  bit<1> block_idx3473;
  action labeledstmt_90(){
    block_idx3473=((bit<1>)hdr.set_signature.set_signature_block_idx);
  }
...
merged_var_precompute4055_sig_addr_precompute4052_4097=((bit<4>)hdr.set_signature.set_signature_sig_idx);
  }
  bit<1> block_idx3476;
  action labeledstmt_92(){
    block_idx3476=((bit<1>)hdr.set_signature.set_signature_block_idx);
  }
...
hdr.set_next_signature.set_next_signature_sig_type=hdr.set_signature.set_signature_sig_type;
    hdr.set_next_signature.set_next_signature_sig_idx=precompute4056;
...
hdr.set_next_signature.set_next_signature_next_signature=hdr.set_signature.set_signature_next_signature;
  ...
  action labeledstmt_96(){
    block_idx3459=(timestamp[4:4]);
  }
  bit<16> tango_metrics_hdr_1;
  CRCPolynomial<bit<16>>(1,false, false, false, 0, 0) hash_40990_crc;
  Hash<bit<16>>(HashAlgorithm_t.CUSTOM,hash_40990_crc) hash_40990;
  action labeledstmt_95(){
    tango_metrics_hdr_1=hash_40990.get({timestamp});
  }
  bit<8> seq_number;
...
merged_var_precompute4055_sig_addr_precompute4052_4097=(merged_var_precompute4055_sig_addr_precompute4052_4097+4w0);
  }
...
merged_var_precompute4055_sig_addr_precompute4052_4097=((timestamp[3:0])+4w0);
  }
...
merged_var_precompute4054_word_addr_precompute_4096=((seq_number[7:5])+3w0);
  }
...
merged_var_precompute4054_word_addr_precompute_4096=(merged_var_precompute4054_word_addr_precompute_4096+10w0);
  }
  ...
  outgoing_metric_signature_manager_0_regaction_4100 = {
...
MetricSignatureManager_sign_ret=outgoing_metric_signature_manager_0_regaction_4100.execute((timestamp[3:0]));
  }
  action labeledstmt_24(){
    labeledstmt_105();
  }
  RegisterAction<bit<32>,bit<4>,bit<32>>(outgoing_metric_signature_manager_0)
  outgoing_metric_signature_manager_0_regaction_4101 = {
    void apply(inout bit<32> cell1_remote,
        out bit<32> ret_remote){
      bit<32> cell1_local=cell1_remote;
      bit<32> cell2_local=0;
...
MetricSignatureManager_sign_ret=outgoing_metric_signature_manager_0_regaction_4101.execute(merged_var_precompute4055_sig_addr_precompute4052_4097);
  }
  action labeledstmt_25(){
    labeledstmt_106();
  }
  RegisterAction<bit<32>,bit<4>,bit<32>>(outgoing_metric_signature_manager_0)
  outgoing_metric_signature_manager_0_regaction_4102 = {
    void apply(inout bit<32> cell1_remote,
        out bit<32> ret_remote){
      bit<32> cell1_local=cell1_remote;
      bit<32> cell2_local=0;
...
outgoing_metric_signature_manager_0_regaction_4102.execute(merged_var_precompute4055_sig_addr_precompute4052_4097);
  }
  action labeledstmt_26(){
    labeledstmt_107();
  }
  RegisterAction<bit<32>,bit<4>,bit<32>>(outgoing_metric_signature_manager_0)
  outgoing_metric_signature_manager_0_regaction_4103 = {
    void apply(inout bit<32> cell1_remote,
        out bit<32> ret_remote){
      bit<32> cell1_local=cell1_remote;
      bit<32> cell2_local=0;
...
outgoing_metric_signature_manager_0_regaction_4103.execute(merged_var_precompute4055_sig_addr_precompute4052_4097);
  }
  ...
  RegisterAction<bit<32>,bit<3>,bit<32>>(outgoing_book_signature_manager_0)
...
sig_bitstring=outgoing_book_signature_manager_0_regaction_4104.execute((seq_number[7:5]));
  }
...
sig_bitstring=outgoing_book_signature_manager_0_regaction_4105.execute(merged_var_precompute4054_word_addr_precompute_4096);
  }
  action labeledstmt_30(){
    labeledstmt_110();
  }
  RegisterAction<bit<32>,bit<10>,bit<32>>(outgoing_book_signature_manager_0)
  outgoing_book_signature_manager_0_regaction_4106 = {
    void apply(inout bit<32> cell1_remote,
        out bit<32> ret_remote){
      bit<32> cell1_local=cell1_remote;
      bit<32> cell2_local=0;
...
outgoing_book_signature_manager_0_regaction_4106.execute(merged_var_precompute4054_word_addr_precompute_4096);
  }
  action labeledstmt_31(){
    labeledstmt_111();
  }
  RegisterAction<bit<32>,bit<10>,bit<32>>(outgoing_book_signature_manager_0)
  outgoing_book_signature_manager_0_regaction_4107 = {
    void apply(inout bit<32> cell1_remote,
        out bit<32> ret_remote){
      bit<32> cell1_local=cell1_remote;
      bit<32> cell2_local=0;
...
outgoing_book_signature_manager_0_regaction_4107.execute(merged_var_precompute4054_word_addr_precompute_4096);
  }
...
hdr.incoming_tango_traffic.incoming_tango_traffic_tango_ip_header_1=precompute4053;
...
hdr.incoming_tango_traffic.incoming_tango_traffic_encaped_udp_header_3=hdr.forward_flow.forward_flow_udp_header_3;
  ...
  @ignore_table_dependency("IngressControl.table_4115")table table_4114 {
    ...
    const entries = {
      (0,2,0,0) : labeledstmt_23();
      (_,2,0,0) : labeledstmt_23();
      (0,4,0,0) : labeledstmt_23();
      (_,4,0,0) : labeledstmt_23();
      (0,1,0,0) : labeledstmt_24();
      (_,1,0,0) : labeledstmt_25();
      (_,3,0,0) : labeledstmt_23();
      (0,2,0,_) : labeledstmt_23();
      (_,2,0,_) : labeledstmt_23();
      (0,4,0,_) : labeledstmt_23();
      (_,4,0,_) : labeledstmt_23();
      (0,1,0,_) : labeledstmt_24();
      (_,1,0,_) : labeledstmt_25();
      (_,3,0,_) : labeledstmt_26();
      (0,2,_,0) : labeledstmt_23();
      (_,2,_,0) : labeledstmt_23();
      (0,4,_,0) : labeledstmt_23();
      (_,4,_,0) : labeledstmt_23();
      (0,1,_,0) : labeledstmt_24();
      (_,1,_,0) : labeledstmt_25();
      (_,3,_,0) : labeledstmt_23();
      (0,2,_,_) : labeledstmt_23();
      (_,2,_,_) : labeledstmt_23();
      (0,4,_,_) : labeledstmt_23();
      (_,4,_,_) : labeledstmt_23();
      (0,1,_,_) : labeledstmt_24();
      (_,1,_,_) : labeledstmt_25();
      (_,3,_,_) : labeledstmt_27();
      (_,_,_,_) : labeledstmt_23();
    } 
  } 
  @ignore_table_dependency("IngressControl.table_4114")table table_4115 {
    ...
    const entries = {
      (0,2,0,0) : labeledstmt_28();
      (_,2,0,0) : labeledstmt_28();
      (0,4,0,0) : labeledstmt_28();
      (_,4,0,0) : labeledstmt_28();
      (0,1,0,0) : labeledstmt_29();
      (_,1,0,0) : labeledstmt_30();
      (_,3,0,0) : labeledstmt_31();
      (0,2,_,0) : labeledstmt_28();
      (_,2,_,0) : labeledstmt_28();
      (0,4,_,0) : labeledstmt_28();
      (_,4,_,0) : labeledstmt_28();
      (0,1,_,0) : labeledstmt_29();
      (_,1,_,0) : labeledstmt_30();
      (_,3,_,0) : labeledstmt_32();
      (0,2,_,_) : labeledstmt_28();
      (0,4,_,_) : labeledstmt_28();
      (0,1,_,_) : labeledstmt_29();
      (_,2,_,_) : labeledstmt_28();
      (_,4,_,_) : labeledstmt_28();
      (_,1,_,_) : labeledstmt_30();
      (_,_,_,_) : labeledstmt_28();
    } 
  } 
